...
Магазин никотиновой продукции в формате **Telegram Mini App** с **веб‑админкой**. Данные каталога и заказов хранятся в **Google Sheets**, медиа — в **S3** (или локально), есть **бот** для Telegram (ссылка на мини‑апп, уведомления/действия по заказам).
