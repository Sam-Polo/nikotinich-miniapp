...
Магазин никотиновой продукции в формате **Telegram Mini App** с **веб‑админкой**.  
Данные каталога и заказов хранятся в **Google Sheets**, медиа — в **S3** (или локально), **бот** для Telegram.
