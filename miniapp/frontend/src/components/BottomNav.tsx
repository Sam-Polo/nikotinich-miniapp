...
const NewsIcon = ({ active }: { active: boolean }) => {
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      {/* news.svg — цвет линий подменяем на наш серый/синий */}
      <path
        d="M8.78393 19.2829L7.53293 20.0329C6.90093 20.4109 6.58493 20.6009 6.26093 20.6699C5.82093 20.7639 5.36393 20.7069 4.96093 20.5099C4.66293 20.3629 4.40293 20.1019 3.88093 19.5799C3.36093 19.0599 3.09993 18.7989 2.95393 18.5009C2.75619 18.0978 2.69983 17.6399 2.79393 17.2009C2.86193 16.8759 3.05193 16.5589 3.42993 15.9269L7.78593 8.64486C8.50393 7.44486 8.86293 6.84486 9.35593 6.58386C9.78893 6.35386 10.2909 6.29286 10.7659 6.40886C11.3099 6.54186 11.8039 7.03686 12.7919 8.02586L15.4279 10.6639C16.4159 11.6529 16.9099 12.1469 17.0439 12.6899C17.1599 13.1659 17.0979 13.6689 16.8689 14.1019C16.6079 14.5959 16.0089 14.9549 14.8089 15.6739L13.5389 16.4349M8.78393 19.2829C8.97807 19.6807 9.26449 20.0264 9.61931 20.2911C9.97412 20.5559 10.3871 20.732 10.8237 20.8048C11.2604 20.8776 11.7081 20.8449 12.1297 20.7096C12.5512 20.5743 12.9342 20.3402 13.2469 20.0269C13.7134 19.5598 13.9987 18.9422 14.052 18.2843C14.1053 17.6264 13.9241 16.9709 13.5389 16.4349M8.78393 19.2829L13.5389 16.4349"
        stroke={stroke}
        strokeWidth="1.5"
      />
      <path
        d="M20.0071 4.40396L17.5421 6.86996M21.2511 9.87696H18.7611M14.5371 3.15796V5.64996"
        stroke={stroke}
        strokeWidth="1.5"
        strokeLinecap="round"
